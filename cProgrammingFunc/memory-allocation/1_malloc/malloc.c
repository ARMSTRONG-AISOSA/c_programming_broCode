...
int main()
{
    ...
    // Check @ notes
    //  malloc: Afunction in C that dynamically allocates a specific number of bytes in memory.
    ...
    // Dangerous to dereference a null poiter it leads to a Segmentation Fault
